...
async def gas(ctx): # * is get all the arguments after the command
  ...
  gas_prices, count = search_gas_prices("Garden Grove")
  await ctx.send(f"\n✅ Here are **`{count}`** the gas stations near you that I found.\n")
  if gas_prices:
      print('Results: ')
